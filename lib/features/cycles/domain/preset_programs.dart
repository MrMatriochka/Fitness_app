...
const List<PresetProgram> presetPrograms = [
  PresetProgram(
    ...
    durationWeeks: 6,
    description:
        '3 séances/semaine · Push / Pull / Legs-Core · déload en fin de cycle',
    sessions: {
      1: [
        ...
        PresetExercise(
            name: 'Gainage (planche)', sets: 3, seconds: 40, rest: 60),
      ],
      3: [
        PresetExercise(
            name: 'Tractions pronation', sets: 4, reps: 6, rest: 120),
      ...
      5: [
        PresetExercise(
            name: 'Squats poids du corps', sets: 4, reps: 15, rest: 90),
  ...
  PresetProgram(
    ...
    durationWeeks: 8,
    description:
        '4 séances/semaine · faible reps, repos longs · déload semaine 8',
    sessions: {
      1: [
        ...
        PresetExercise(
            name: 'Gainage (planche)', sets: 3, seconds: 45, rest: 60),
      ],
      2: [
        PresetExercise(
            name: 'Tractions pronation', sets: 5, reps: 5, rest: 150),
        PresetExercise(
            name: 'Tractions négatives', sets: 3, reps: 4, rest: 120),
      ...
      4: [
        PresetExercise(
            name: 'Bulgarian split squat', sets: 4, reps: 8, rest: 120),
      ...
      5: [
        PresetExercise(
            name: 'Handstand wall hold', sets: 5, seconds: 20, rest: 90),
  ...
  PresetProgram(
    ...
    durationWeeks: 6,
    description:
        '4 séances/semaine · Upper Push / Upper Pull / Legs / Full Body',
    sessions: {
      1: [
        PresetExercise(name: 'Pompes classiques', sets: 4, reps: 15, rest: 75),
        PresetExercise(name: 'Dips', sets: 4, reps: 12, rest: 75),
        PresetExercise(
            name: 'Développé haltères épaules', sets: 4, reps: 10, rest: 75),
        PresetExercise(
            name: 'Élévations latérales haltères', sets: 3, reps: 15, rest: 60),
        PresetExercise(
            name: 'Extension triceps haltère', sets: 3, reps: 12, rest: 60),
        PresetExercise(
            name: 'Gainage (planche)', sets: 3, seconds: 45, rest: 60),
      ],
      2: [
        ...
        PresetExercise(name: 'Curl haltères', sets: 3, reps: 12, rest: 60),
        PresetExercise(
            name: 'Reverse fly haltères', sets: 3, reps: 15, rest: 60),
      ...
      5: [
        ...
        PresetExercise(
            name: 'Squats poids du corps', sets: 3, reps: 15, rest: 75),
        PresetExercise(name: 'Pike push-up', sets: 3, reps: 10, rest: 75),
        PresetExercise(
            name: 'Relevés de genoux suspendu', sets: 3, reps: 10, rest: 60),
      ],
    },
  ),
  PresetProgram(
    ...
    durationWeeks: 6,
    description:
        '3 séances/semaine · varier force / volume / technique pour préserver coudes-épaules',
    sessions: {
      1: [
        PresetExercise(
            name: 'Tractions pronation', sets: 5, reps: 5, rest: 150),
        PresetExercise(
            name: 'Tractions négatives', sets: 3, reps: 3, rest: 120),
  ...
  PresetProgram(
    ...
    sessions: {
      1: [
        PresetExercise(name: 'Hollow hold', sets: 4, seconds: 30, rest: 60),
        PresetExercise(
            name: 'Gainage (planche)', sets: 4, seconds: 60, rest: 60),
        PresetExercise(name: 'Gainage latéral', sets: 3, seconds: 30, rest: 45),
      ...
      3: [
        PresetExercise(
            name: 'Relevés de genoux suspendu', sets: 4, reps: 10, rest: 60),
        PresetExercise(
            name: 'Mountain climbers', sets: 3, seconds: 40, rest: 45),
